...
clear all;
savefolder = '20191121_ThresPhiEvol_varyT';
...
ns = nphi*nthres;       % Total number of strains
...
for i=1:nTt
    ...
    % Define within-transfer time vector
    dtau = Tt/ntausteps;
    tau = 0:dtau:Tt;        
    ltau = length(tau);
    ...
    for j = 1:nt
        ...
        % Check if integration was successful over full transfer period
