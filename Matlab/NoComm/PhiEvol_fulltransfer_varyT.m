...
clear all;
savefolder = '20200819_PhiEvol_fulltransfer';
...
for i=1:nTt
    ...
    fun = @(z) (one_transfer_results(tau,[InitS,dilute*z(2),dilute*z(3:(ns+2)),dilute*z((ns+3):end)],phi,r,K,B,alpha,deltaP,a,cL,deltaA,u,mu,mut_type) - z);
